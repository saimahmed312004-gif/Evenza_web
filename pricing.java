        ...
        // Billing toggle
        let annual = false;
        const prices = { std: [799, 639], prem: [1499, 1199], elite: [3299, 2639], virt: [199, 159] };
        function toggleBilling() {
            annual = !annual;
            document.getElementById('toggle-sw').classList.toggle('on', annual);
            document.getElementById('lbl-m').classList.toggle('on', !annual);
            document.getElementById('lbl-a').classList.toggle('on', annual);
            const i = annual ? 1 : 0;
            document.getElementById('p1').textContent = prices.std[i].toLocaleString();
            document.getElementById('p2').textContent = prices.prem[i].toLocaleString();
            document.getElementById('p3').textContent = prices.elite[i].toLocaleString();
            document.getElementById('pv').textContent = '$' + prices.virt[i];
            document.getElementById('p1-orig').textContent = annual ? 'Was $799' : '';
            document.getElementById('p2-orig').textContent = annual ? 'Was $1,499' : '';
            document.getElementById('p3-orig').textContent = annual ? 'Was $3,299' : '';
        }
